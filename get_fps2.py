...
def main():
    ...
    parser.add_argument('--weights',type=str, default='runs/TIB/yolo26-DPC3k2-ConverseSample-C2PSCAA/weights/best.pt', help='loading weights')
...
if __name__ == '__main__':
    ...
    results=model.val(
              data="/media/ubuntu/DATA/md/YOLOv26n/datasets/TIB-Net/tibnet.yaml",
              batch=1, 
              imgsz=640,
              device=0,
              half=True,

              project="/media/ubuntu/DATA/md/YOLOv26n/runs/detect/TIB",
              name='yolo26-6-DPC3k2-ConverseSample-C2PSCAA')
