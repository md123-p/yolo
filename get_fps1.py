...
def main():
    ...
    parser.add_argument('--weights',type=str, default='runs/visdrone/yolo26n-DPC3k2-ConverseSample-C2PSCAA/weights/best.pt', help='loading weights')
...
if __name__ == '__main__':
    ...
    results=model.val(
              data="/media/ubuntu/DATA/njx/yolov10-main/ultralytics/cfg/datasets/VisDrone.yaml",
              batch=1, 
              imgsz=640,
              device=0,
              half=True,

              project="/media/ubuntu/DATA/md/YOLOv26n/runs/detect/visdrone",
              name='yolo26n-DPC3k2-ConverseSample-C2PSCAA')
